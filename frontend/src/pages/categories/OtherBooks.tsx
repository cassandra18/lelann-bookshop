...
const OtherBooks: React.FC = () => {
  const { category_id, loading, error, totalPages, setTotalPages } = useCategoryData('Other Books');
  ...
  const [priceSortOrder, setPriceSortOrder] = useState<string>(''); // Initialize as empty string
